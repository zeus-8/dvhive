                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="anio" class="form-control" id="exampleInputEmail1" placeholder="Año" value="{{ $user->period_year }}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="exampleInputEmail1">INICIO</label>
                                <select name="inicio" class="form-control select2bs4" style="width: 100%;">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="turno" class="form-control select2bs4" style="width: 100%;">
                       ...
                       <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="modalidad" class="form-control select2bs4" style="width: 100%;">
                        ...
                        <div class="col-md-4 offset-md-8">
                            <div class="row">
                                <div class="col-md-6"><br>
                                    {!! Form::hidden('id_person', $value = $user->id_person); !!}
                                    {!! Form::hidden('id_career', $value = $user->id_career); !!}
                                    
                                    <button type="submit" class="btn btn-block btn-outline-success btn-lg">Modificar</button>
                                </div>
                                <div class="col-md-6"><br>
